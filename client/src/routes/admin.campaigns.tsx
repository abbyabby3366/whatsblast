...
type Campaign = { id: string; name?: string; status?: string; user?: string | User; created_at?: string; recipient_phones?: string[]; templates?: Array<{ text?: string }>; min_interval_seconds?: number; max_interval_seconds?: number; enable_warmup?: boolean }
