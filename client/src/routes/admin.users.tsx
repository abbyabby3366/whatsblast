...
function AdminUsersPage() {
  ...
  return <div className="space-y-4">
    <div className="flex items-center justify-between"><div><h2 className="text-xl font-bold tracking-tight">Users & Merchants</h2><p className="text-xs text-slate-500">Create, edit, deactivate, and delete accounts.</p></div><Button onClick={() => { setForm(emptyForm); setOpen(true) }}><Plus className="mr-2 h-4 w-4" /> Add User</Button></div>
